...
public class HashtagsFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private interface HashtagsQuery {
        int      TOKEN               = 0x1;
        String[] PROJECTION          = {ScheduleContract.Hashtags._ID, ScheduleContract.Hashtags.HASHTAG_NAME,
    ...
    private static class HashtagsAdapter extends CursorAdapter implements CollectionViewCallbacks {
        ...
        public CollectionView.Inventory getInventory() {
            ...
            // setup hero hashtag
            inventory.addGroup(new CollectionView.InventoryGroup(HERO_GROUP_ID).setDisplayCols(1).setItemCount(1).setShowHeader(false));

            // setup other hashtags
            inventory.addGroup(new CollectionView.InventoryGroup(HashtagsQuery.TOKEN).setDisplayCols(mContext.getResources().getInteger(R.integer.social_grid_columns)).setItemCount(mCursor.getCount() - 1).setDataIndexStart(1).setShowHeader(false));
            return inventory;
        }
        ...
        public void bindHeroView(View view, Context context, Cursor cursor) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    /*
                     * [ANALYTICS:EVENT] TRIGGER: Click on a hashtag on the Social screen to launch Google+ CATEGORY:
                     * 'Social' ACTION: selecthashtag LABEL: the selected hashtag, e.g. '#io14 #design' [/ANALYTICS]
                     */
