...
public class SocialActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (null == savedInstanceState) {
			getFragmentManager().beginTransaction().replace(R.id.container, HashtagsFragment.newInstance()).commit();
		}

		/*
		 * [ANALYTICS:SCREEN] TRIGGER: View the Social screen LABEL: 'Social' [/ANALYTICS]
		 */
