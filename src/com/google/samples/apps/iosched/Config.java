...
public class Config {
    ...
    public static final long[][] CONFERENCE_DAYS                          = new long[][] {
            ...
            {ParserUtils.parseTime("2014-06-25T07:00:00.000Z"), ParserUtils.parseTime("2014-06-26T06:59:59.999Z")},
            // start and end of day 2
            {ParserUtils.parseTime("2014-06-26T07:00:00.000Z"), ParserUtils.parseTime("2014-06-27T06:59:59.999Z")},};
    ...
    public static final long     WIFI_SETUP_OFFER_START                   = CONFERENCE_START_MILLIS - 3 * DAY_MILLIS;      // 3
                                                                                                                            // days
                                                                                                                            // before
                                                                                                                            // conference
    ...
    public static final String   VIDEO_LIBRARY_FALLBACK_THUMB_URL_FMT     = "http://img.youtube.com/vi/%s/default.jpg";
    ...
    public interface Tags {
        ...
        public static final String[]             EXPLORE_CATEGORIES            = {CATEGORY_THEME, CATEGORY_TOPIC,
                                                                                       CATEGORY_TYPE};

        public static final int[]                EXPLORE_CATEGORY_ALL_STRING   = {R.string.all_themes,
                                                                                       R.string.all_topics,
                                                                                       R.string.all_types};

        public static final int[]                EXPLORE_CATEGORY_TITLE        = {R.string.themes, R.string.topics,
                                                                                       R.string.types};
    }
    ...
    public static final Uri      SESSION_DETAIL_WEB_URL_PREFIX = Uri.parse("https://www.google.com/events/io/schedule/session/");
