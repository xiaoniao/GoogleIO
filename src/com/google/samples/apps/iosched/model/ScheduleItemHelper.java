...
public class ScheduleItemHelper {
    ...
    /**
     * Find and resolve time slot conflicts. Items should already be ordered by start time. Conflicts among
     * mutableItems, if any, won't be checked, and they will be left as is.
     **/
    ...
    static private boolean intersect(ScheduleItem block1, ScheduleItem block2, boolean useOverlap) {
        return block2.endTime > (block1.startTime + (useOverlap ? ALLOWED_OVERLAP : 0)) && (block2.startTime + (useOverlap ? ALLOWED_OVERLAP : 0)) < block1.endTime;
    }
