...
public class ScheduleWidgetProvider extends AppWidgetProvider {
    ...
    private static final String REFRESH_ACTION     = "com.google.samples.apps.iosched.appwidget.action.REFRESH";
    private static final String EXTRA_PERFORM_SYNC = "com.google.samples.apps.iosched.appwidget.extra.PERFORM_SYNC";

    public static Intent getRefreshBroadcastIntent(Context context, boolean performSync) {
        return new Intent(REFRESH_ACTION).setComponent(new ComponentName(context, ScheduleWidgetProvider.class))
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            final Intent intent = new Intent(context, ScheduleWidgetRemoteViewsService.class).putExtra(
            ...
            final PendingIntent openAppPendingIntent = PendingIntent.getActivity(context, 0, openAppIntent,
                    PendingIntent.FLAG_UPDATE_CURRENT);
